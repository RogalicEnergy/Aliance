...
<?php include_once('./template-parts/production.php')?>
<section class="section contracts">
  <div class="container">
    <div class="contracts-blocks">
    ...
    <svg class="contracts-icon" width="24" height="24">
      <use href="img/sprite.svg#load"></use>
    </svg>
    <a href="#" class="button-link-contracts">Читать больше</a>
    </div>
    </div>
  </div>
</section>
